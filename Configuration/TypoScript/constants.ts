...
ns_theme_cleanblog {	
	website {
		...
		hfooter {
            #cat = ns_theme_cleanblog/website/hfooter/01; type=string; label=Footer Copyright Last Link Text
            linktext =
            #cat = ns_theme_cleanblog/website/hfooter/02; type=string; label=Footer Copyright Last Link
            link =
        }
		paths {
